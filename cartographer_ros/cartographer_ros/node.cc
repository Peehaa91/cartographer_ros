...
void Node::LaunchSubscribers(const TrajectoryOptions& options,
  ...
  if (node_options_.ground_plane_detection) {
	string topic = "ground_plane";
	ground_plane_subscribers_[trajectory_id] = node_handle_.subscribe<cartographer_ros_msgs::PlaneStamped>(topic,
    		kInfiniteSubscriberQueueSize,
			boost::function<void(const cartographer_ros_msgs::PlaneStamped::ConstPtr&)>(
				[this, trajectory_id, topic]
...
bool Node::HandleFinishTrajectory(
  ...
  ShutdownSubscriber(ground_plane_subscribers_, trajectory_id);
